...
#define error_attack_not_actable_class	-24	//다른 클래스의 스킬인경우 1레벨이상은 못씀
#define error_attack_lack_gauge		-25	//hp, fp, sp등이 모자름..
#define error_attack_not_define_bullet -26	//원거리 무기에 총알을 장착안한 상태
...
#define error_sf_not_actable_class	16	//다른 클래스의 스킬인경우 1레벨이상은 못씀
...
#define error_dungeon_ride_unit		12	//유닛 탑승 상태
...
#define error_unit_no_match_bullet	26	//무기와 총알의 타입이 다르다..
#define error_unit_no_delivery_area	27	//유닛배달가능 지역이 아님..
...
#define error_tower_lack_fp				14	//FP가 모자름
